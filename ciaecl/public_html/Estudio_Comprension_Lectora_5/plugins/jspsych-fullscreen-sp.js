 ...
 * Josh de Leeuw
 * (Edited from jspsych-fullscreen.js for spanish instructions)
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      message: {
        ...
        pretty_name: 'Message',
        default: '<p style="font-size: 120%">El experimento se realizará en pantalla completa para evitar distracciones.<br>El tamaño de la letra ha sido escogido para los propósitos de este estudio,<br> aún asi, si te incomoda, puedes aumentarlo con Ctrl+.<br>Presiona "continuar".</p>',
        array: false,
