      ...
      questions: {
        ...
        nested: {
          ...
          margin: {
            type: jsPsych.plugins.parameterType.STRING,
            pretty_name: 'Margin',
            default: 'margin-right: 10%; margin-left: 10%;',
            description: "Margin right and left of option section"
          } 
        }
      },
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      for (var j = 0; j < question.options.length; j++) {
        ...
        html += '<div id="'+option_id_name+'" class="jspsych-survey-multi-choice-option" style="font-size: 120%; text-align:left; justify-content:space-between;'+question.margin+'">';
