		...
		<script>
			changeTextId('fieldset_title_form','{caso_form} convenio');
</script>
 ...
 <div  id='detalle_persona'>
	...
	<div class="fieldset_campos">
		<label id='texto_busqueda_inicial'>		N&uacute;mero de convenio </label> 
				  <input  type="text" class='inputtext' name='formconvenio_investigador' value="{numero_convenio}">
	</div>
   ...
   <label>		Fecha de convenio </label> 
	...
	<div class="fieldset_campos">
		<label id='texto_busqueda_inicial'>		N&uacute;mero de decreto </label> 
				  <input  type="text" class='inputtext' name='formconvenio_investigador' value="{numero_decreto}">
	</div>
	<div class="fieldset_campos">
		<label id='texto_busqueda_inicial'>		N&uacute;mero de memo</label> 
				  <input  type="text" class='inputtext' name='formconvenio_investigador' value="{numero_memo}">
	</div>
   ...
   <label>		Fecha de t&eacute;rmino </label> 
		...
		<label id='texto_busqueda_inicial'>		Labor  </label> 
				  <textarea class='inputtext' name="formconvenio_labor" >{labor}</textarea>
	</div>
	<div class="fieldset_campos">
		<label id='texto_busqueda_inicial'>		Labor resumida </label> 
				  <textarea class='inputtext' name="formconvenio_labor_resumida" maxlength="70">{labor_resumida}</textarea>
	</div>
	<div class="fieldset_campos">
