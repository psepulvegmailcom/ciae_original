...
function textCounter(field, countfield, maxlimit) 
{
	...
	{
		$(countfield).innerHTML  =   field.value.length+' caracteres de un m&aacute;ximo de '+ maxlimit;
	}
}
</script> 
...
<tr class='Form'>
<td class='Form'>Ep&iacute;grafe</td>
<td class='Form'>
	<input type="text" name="noticia_epigrafe"  class='inputtext' value="{noticia_epigrafe}" maxlength="255">
</td>
</tr>
<tr class='Form'>
<td class='Form' width="25%">T&iacute;tulo</td>
<td class='Form'>
<span id="noticia_titulo_max">{noticia_titulo_max} caracteres de un m&aacute;ximo de 255</span><br /> 
...
<tr class='Form'>
<td class='Form' width="25%">T&iacute;tulo Interno</td>
<td class='Form'>
<span id="noticia_titulo_interno_max">{noticia_titulo_interno_max} caracteres de un m&aacute;ximo de 255</span><br />
...
<td class='Form'>  
<span id="noticia_bajada_home_max">{noticia_bajada_home_max} caracteres de un m&aacute;ximo de 600</span><br />
...
<td class='Form'>
<span id="noticia_bajada_noticia_max">{noticia_bajada_noticia_max} caracteres de un m&aacute;ximo de 600</span><br />
...
<tr class='Form'>
	<td class='Form'>Edici&oacute;n</td>
...
<td class='Form'>
	<select name="noticia_idioma" class='inputtext'>
		...
		<option {noticia_idioma_es} value="es">Espa&ntilde;ol</option>
		<option {noticia_idioma_en} value="en">Ingl&eacute;s</option>
	</select> (*)
</td>
</tr>

<tr class='Form'>
<td class='Form'>Publicaci&oacute;n</td>
<td class='Form'>
...
syncTextarea() ;
	...
	{
		alert('Debe seleccionar el lado de aparici&oacute;n de la imagen');
