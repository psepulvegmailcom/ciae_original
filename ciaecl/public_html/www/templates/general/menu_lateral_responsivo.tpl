...
<div class="navbar navbar-default" role="navigation">
 <div class="container">
     ...
     <div  style=" font-size:24px; text-align:right; float:right;  padding-right:10px;" >
                <table style="width:100%; " border="0">
                <tr>
                    <td style="text-align:right; font-size: 24px"><a href="https://www.facebook.com/ciae.uchile/"  title="Facebook " target="_blank" class="social"><i class="fa fa-facebook"></i></a>&nbsp;&nbsp; 
                    <a href="https://twitter.com/ciae.uchile"  title="Twitter" class="social"><i class="fa fa-twitter"></i></a>&nbsp;&nbsp;
					<a href="https://www.instagram.com/ciae_uchile/" class="social" target="_blank"><i class="fa fa-instagram"></i></a>&nbsp;&nbsp;
                    <a href="https://www.youtube.com/c/CIAEUchile" title="Youtube" class="social" target="_blank"><i class="fa fa-youtube"></i></a>&nbsp;&nbsp; 
                    <a href="http://www.linkedin.com/company/ciae---universidad-de-chile" title="Linkedin Ciae Uchile" class="social" target="_blank"><i class="fa fa-linkedin"></i></a>&nbsp;&nbsp;  
                    <a href="https://www.ciae.uchile.cl/rss.php" title="Rss Ciae UChile" class="social" target="_blank"><i class="fa fa-rss"></i></a>&nbsp;&nbsp;  
                    </td>
