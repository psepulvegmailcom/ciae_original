        ...
        <div class="banner-home">
         ...
         <div style="text-align:center">
			 ...
			 <a href="http://libros.uchile.cl/files/presses/1/monographs/855/submission/proof/index.html#/4es" target="_blank"  style="border:none ">
              <img src="imageview.php?image=banner/00_1555008269.png" border="1" width="300px;" height="190px;" title="Revise ac&aacute; el folleto de los 10 a&ntilde;os del CIAE"> </a>
		 	</p>

		 	 <!--<p style="vertical-align:top "><br>
			 <a href="https://www.ciae.uchile.cl/trabajaconnosotros.html"    style="border:none ">
             <img src="www/imag/banner-fijo.jpg" border="0"  title="Trabaja con nosotros"> </a>
		 	</p> -->
          </div>
