<table width="90%" border="0" cellpadding="3">
 <tr>
<td colspan="2"><br /><strong style="text-decoration:underline"> <!--Su inscripci&oacute;n se confirmar&aacute; telef&oacute;nicamente, por lo que es requisito ingresar sus datos correctamente. <br /><br />Esta confirmaci&oacute;n es requisito para poder participar en el seminario.  <br /> 
<br /> --> Por favor, revise bien el ingreso de sus datos, tal cual como usted los ingrese ser&aacute;n utilizados en su certificaci&oacute;n. Sin posibilidad de modificaci&oacute;n. </strong></td></tr>
  <tr><td colspan="2">&nbsp;<br /></td></tr>
   ...
   <tr>
    ...
    <div style="visibility:hidden"><input type="radio" name="form_tipo_inscripcion"   value="20130708_mineduc_modelamiento_presencial"   disabled="disabled" > 08 de julio de 2013:  Asistencia presencial   <br> </div>
	<input type="radio" name="form_tipo_inscripcion"   value="20130708_mineduc_modelamiento_online" checked="checked"> <!--08 de julio de 2013:  Asistencia online v&iacute;a streaming -->Participaci&oacute;n en sistema de actividades<br>
