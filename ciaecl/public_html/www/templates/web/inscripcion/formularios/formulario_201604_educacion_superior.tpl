...
<td colspan="2"><br />
 ...
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_educacion_superior"> 
  ...
  <tr>
    ...
    <div ><input type="radio" name="form_tipo_inscripcion"   value="201604_educacion_superior_presencial"    > Asistencia presencial   <br>  
	<input type="radio" name="form_tipo_inscripcion"   value="201604_educacion_superior_online" >  Asistencia via streaming<br>
