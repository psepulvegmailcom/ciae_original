<table width="90%" border="0" cellpadding="3">
  <tr>
    ...
    <td style="width:70%"> 
        <input type="text" name="form_rut" style="width:50%" maxlength="255" value="{email}"  > (00000000-0)    </td>
  </tr>
  <tr>
...
<tr>
<td colspan="2"><br /><small>(*) Campos obligatorios</small><br /><small>(**) En caso de eventos presenciales, no se dispone de estacionamientos</small></td>
</tr>
