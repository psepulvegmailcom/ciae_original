...
<td colspan="2"><br />
 ...
 <input type="hidden" name="form_tipo_inscripcion" value="201605_seminario_escritura_lenguaje">
 
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_lenguaje"> 
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_escritura_lenguaje"> 
