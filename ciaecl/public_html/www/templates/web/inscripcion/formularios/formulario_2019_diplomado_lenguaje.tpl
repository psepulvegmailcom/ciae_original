...
<td colspan="2"><br />
 ...
 <input type="hidden" name="form_tipo_inscripcion" value="2019_diplomado_lenguaje">
 ...
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_gestion_curricular">   
  ...
  <tr><td colspan="2">&nbsp;<br /></td></tr>  <tr>
    <td ><strong>Copia de liquidaciones  (si postular&aacute; a beca)</strong></td> 
    <td  >  <input type="file" name="archivo_extra4" id="archivo_extra4"> </td>
  </tr> 

    <tr><td colspan="2">&nbsp;<br /></td></tr>  <tr>
    <td ><strong>Certificado de participaci&oacute;n en alguno de los cursos de lenguaje en el CIAE 
      el a&ntilde;o 2018 (si postular&aacute; a beca)</strong></td> 
