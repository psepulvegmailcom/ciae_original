		...
		<!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/formulario_inicia_rendicion_2014_revision_detalle_clausula.tpl -->
		...
		<!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/validacion/nacionalidad.tpl -->  
		<!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/validacion/fecha_nacimiento.tpl --> 
		<!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/formulario_inicia_rendicion_2014_revision_detalle.tpl -->
