...
<br> 
  ...
  var academica_carrera_base = '{inicia_situacion_academica_carrera}';
    ...
    <td>
        <input  type="text" name="form_inicia_situacion_academica_institucion" style="width:100% "  maxlength="255" value="Universidad Adventista de Chile"> 
	   </td>
  </tr>
 ...
 <tr><td colspan="2"></td></tr>
  ...
  <tr><td colspan="2"></td></tr>
    ...
    <td>
		...
		<strong>Sede  (*) </strong><br></td>
    <td>
	 
	    
	 <input type="radio" name="form_inicia_rendicion_sede"  checked onclick="javascript:revisionClausulasInscripcion();" value="chillan"> <strong>Chill&aacute;n.</strong> Universidad Adventista de Chile  
 <br>  
  ...
  checkedValue('form_inicia_rendicion_sede','{inicia_rendicion_sede}');
    ...
    <td>
		...
		<strong>Fecha   </strong><br><small></small>
	<a name="form_inicia_rendicion_fecha_a" id="form_inicia_rendicion_fecha_a"></a>
   
	</td>
    <td>  
	 
	<input type="radio" name="form_inicia_rendicion_fecha"  onclick="javascript:revisionClausulasInscripcion();"  checked  value="20160502-jornada_completa">	<strong> 02 de mayo de 2016, jornada completa </strong>(09:00 a 12:00 y 14:00 a 17:00 horas)<br>
	</td>
	</tr>
