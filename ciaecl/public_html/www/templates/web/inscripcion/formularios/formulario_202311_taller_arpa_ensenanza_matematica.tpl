<table width="90%" border="0" cellpadding="3">
	...
	<tr>
		...
		<tr>
			<td><strong>En el caso de ser docente, indicar en que nivel imparte clases  </strong></td>
			<td> 
			<input type="text" name="form_campo_extra1"  id="form_campo_extra1" style="width:100% " value="{campo_extra1}" maxlength="255"> <br>
			</td>
		</tr>
		<tr>
			<td><strong>Ha parcitipado anteriormente en talleres de ARPA?  </strong></td>
			<td> 
			
				<input type="radio" name="form_campo_extra2" id="form_campo_extra2" value="Si" > Si<br>
				<input type="radio" name="form_campo_extra2" id="form_campo_extra2" value="No" > No<br>
			</td>
		</tr>
