...
<div id='inscripcion_ficha'>  
    <!-- START BLOCK : bloque_formulario --> 
	   <!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/formulario_202204_concurso_postdoc.tpl -->
...
<div id='inscripcion_programa'  > 
  <!-- INCLUDE BLOCK : www/templates/web/inscripcion/202204_concurso_postdoc-programa.tpl --> 
