<a name="formulario"></a>
 <div class="contenido_titulo_separador">CONVOCATORIA PARA TRES POSICIONES POSTDOCTORALES EN CIAE DE LA UNIVERSIDAD DE CHILE</div>
...
<div id='inscripcion_ficha'>  
    <!-- START BLOCK : bloque_formulario --> 
	   <!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/formulario_202209_concurso_postdoc.tpl -->
...
<div id='inscripcion_programa'  > 
  <!-- INCLUDE BLOCK : www/templates/web/inscripcion/202209_concurso_postdoc-programa.tpl --> 
...
<li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_ficha');"><strong>Postulaci&oacute;n </strong> </a></li>
 ...
 <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_fecha" ><strong>Fecha Cierre Postulación:</strong><br />
  25 de octubre de 2022 </li>
 
<br>
  </p>    
   <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_consulta"><strong>Consultas o dudas:</strong>  <a href="mailto:diplomadolenguaje@ciae.uchile.cl?subject=Diplomado de Lenguaje, 2020" target="_blank">contacto@ciae.uchile.cl</a> </li> 
