<a name="formulario"></a>
 ...
 <input type="hidden" name="form_tipo_inscripcion" value="20120515_produccionescrita">
...
<!-- INCLUDE BLOCK : www/templates/web/bloque_redondeado_header.tpl --> 
 <li  class="lateral_inscripcion" style="font-size:13px; " ><strong>Fecha:</strong> <strong>15 de mayo de 2012</strong></li> 
