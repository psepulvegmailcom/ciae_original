<h1 class="title--despliegue text-center">{titulo}  /{tipo}</h1>
	        ...
	        <div class="{div2}">
		 <!-- START BLOCK : bloque_elemento_imagen2 -->

          <figure>
            <img src="imageview.php?image=recursos/{imagen2}&texto={imagen_bajada}" />
          </figure>

			<!-- END BLOCK : bloque_elemento_imagen2 -->
        </div>
        <div class="box--info-despliegue">
	     ...
	     <!-- END BLOCK : bloque_elemento_link_externo -->
			...
			<div class="col-12 col-md-2 text-center">
              ...
              <a href="download.php?file=recursos/{archivo2}" class="d-inline-block m-1"><img src="www/style/bib/images/icon-pdf.jpg" /></a>
