<div class="container">
 ...
 <div class="row">
     ...
     <div class="col-sm-8 single-new">
		  <div class="blue box-style box-buscador">
            <div class="row">
              ...
              <div class="col-sm-4">
                <select class="form-control margin-form" name="buscador_tipo" id="buscador_tipo" placeholder="Tipo de Noticia">
		...
		<!-- START BLOCK : bloque_elemento --> 
        	...
        	<div class="col-md-12">
            <ul>
 			 <li><small> {fecha_html_full}<!--{fecha}--></small> &nbsp; <a href="index.php?page=view_noticias&id={id_noticia}&langSite={langSiteEspecial_seleccionado}">{titulo}</a> </li>
            </ul>
        	</div> 
         	</div>      
        ...
        <!-- START BLOCK : bloque_elemento_prensa --> 
            ...
            <ul>
 			 <li>
             <a href="{url}" target="_blank">{titulo}</a>&nbsp;<a href="{url}" target="_blank"   id="link_blank"><img src="www/images/iconos/32x32/Target_blank.png" class="open_target_blank"></a><p /> {bajada} <p />{medio}, <small> {fecha}</small>
	...
	<!-- END BLOCK : bloque_home_prensa_der_detalle -->

	<h3>Especiales informativos</h3>
	<!-- START BLOCK : bloque_home_boletin_informativo_detalle -->
	<div class="post-new row">
		<div class="col-md-12">
			<!-- INCLUDE BLOCK : www/templates/general/version_home_boletin_informativo.tpl -->
		</div>
	</div>
	<!-- END BLOCK : bloque_home_boletin_informativo_detalle -->
