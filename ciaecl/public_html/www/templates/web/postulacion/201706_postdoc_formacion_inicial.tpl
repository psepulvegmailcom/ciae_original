<a name="formulario"></a>
 <div class="contenido_titulo_separador">	Concurso internacional para puesto de postdoctorado: Educaci&oacute;n inicial <!--/ International competition for post-doctorate position: Early childhood education--> 
...
<td style="width:70%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="201706_postdoc_formacion_inicial">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/201706_postdoc_formacion_inicial_descripcion.tpl -->
 </div>
...
<!-- <li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_programa');"><strong>Programa</strong>  </a></li> -->
 <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_fecha" ><strong>Fecha cierre postulaci&oacute;n <!--/ Application Deadline--></strong><br /> 
   ...
   <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_consulta"> Para mayor informaci&oacute;n <!--/ For more information-->  <br><a href="mailto:postulacion@ciae.uchile.cl?subject=Puesto de Postdoctorado Educacion inicial 2017">postulacion@ciae.uchile.cl</a> </li> 
