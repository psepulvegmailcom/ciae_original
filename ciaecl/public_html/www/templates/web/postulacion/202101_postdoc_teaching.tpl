<a name="formulario"></a>
 <div class="contenido_titulo_separador">
  POSTDOCTORAL POSITION ON TEACHING PROFESSION 
 </div>
...
<td style="width:65%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="202101_postdoc_teaching">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/202101_postdoc_teaching_descripcion.tpl -->
 </div>
