<a name="formulario"></a>
 <div class="contenido_titulo_separador">
   POSICIONES POSTDOCTORALES EN EDUCACI&Oacute;N ENCHILE / POSTDOCTORAL POSITION IN EDUCACTION IN CHILE
 </div>
...
<td style="width:65%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="202011_postdoc_educacion">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/202011_postdoc_educacion_descripcion.tpl -->
 </div>
