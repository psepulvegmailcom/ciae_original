<a name="formulario"></a>
 <div class="contenido_titulo_separador">	Llamado a concurso internacional para puesto de postdoctorado / Call for proposals: international competition for  post-doctorate positions
...
<td style="width:60% ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="201511_postdoctorado">
<div id='inscripcion_ficha'>  
    

    <!-- START BLOCK : bloque_formulario -->     
    	<!-- INCLUDE BLOCK : www/templates/web/postulacion/201511_postdoctorado_formulario.tpl -->     
    <!-- END BLOCK : bloque_formulario --> 
    <!-- START BLOCK : bloque_formulario_carta -->     
    	<!-- INCLUDE BLOCK : www/templates/web/postulacion/201511_postdoctorado_formulario_carta.tpl -->     
    <!-- END BLOCK : bloque_formulario_carta --> 
 
</div>
 
  <div id='inscripcion_convocatoria' style=" width:600px "> 
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/201511_postdoctorado_descripcion.tpl -->
 </div>
...
<!-- <li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_programa');"><strong>Programa</strong>  </a></li> -->
 <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_fecha" ><strong>Fecha cierre postulaci&oacute;n / Application Deadline</strong><br /> 
   31 de Marzo de 2016 / March 31, 2016</li>     
  
   
   <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_consulta"> Para mayor informaci&oacute;n / For more information  <a href="mailto:postulacion@ciae.uchile.cl?subject=Puesto de Postdoctorado / Post-doctorate Positions 2016">postulacion@ciae.uchile.cl</a> </li> 
