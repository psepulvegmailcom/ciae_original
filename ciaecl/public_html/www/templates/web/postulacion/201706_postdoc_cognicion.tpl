...
<td style="width:70%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="201706_postdoc_cognicion">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/201706_postdoc_cognicion_descripcion.tpl -->
 </div>
...
<!-- <li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_programa');"><strong>Programa</strong>  </a></li> -->
 <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_fecha" ><strong>Application Deadline</strong><br /> 
   ...
   <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_consulta">  For more information  <a href="mailto:postulacion@ciae.uchile.cl?subject=Post-doctorate Positions Neuroscience and Cognition 2017">postulacion@ciae.uchile.cl</a> </li> 
