<a name="formulario"></a>
 <div class="contenido_titulo_separador">	Concurso internacional para puesto de postdoctorado en ense&ntilde;anza y aprendizaje de la escritura
</div>
...
<td style="width:70%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="201711_postdoc_lenguaje_escritura">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/201711_postdoc_lenguaje_escritura_descripcion.tpl -->
 </div>
