<a name="formulario"></a>
 <div class="contenido_titulo_separador">
   POSICIONES POSTDOCTORALES EN CIAE UNIVERSIDAD DE CHILE / POSTDOCTORAL POSITION AT CIAE UNIVERSIDAD DE CHILE
 </div>
...
<td style="width:65%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="201910_postdoc_ensenanza_aprendizaje">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/201910_postdoc_ensenanza_aprendizaje_descripcion.tpl -->
 </div>
...
<li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_ficha');"><strong>Formulario Postulaci&oacute;n / Application Form <!--/ Application Form--> </strong> </a></li>
<li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_convocatoria');"><strong>Posici&oacute;n Post Doctoral/ Post Doctoral Position <!--/ Post Doctoral Position--> </strong>  </a></li>
<!-- <li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_programa');"><strong>Programa</strong>  </a></li> -->
 <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_fecha" ><strong>Fecha cierre postulaci&oacute;n / Application Deadline <!--/ Application Deadline--></strong><br /> 
  31 de octubre de 2019  / October 31, 2019</li>     
  
   
   <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_consulta"> Para mayor informaci&oacute;n <!--/ For more information-->  <br><a href="mailto:postulacion@ciae.uchile.cl?subject=Puesto de Postdoctorado Ense&ntilde;anza y aprendizaje del lenguaje 2019">postulacion@ciae.uchile.cl</a> </li> 
