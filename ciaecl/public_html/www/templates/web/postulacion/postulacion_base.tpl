...
<div id='inscripcion_ficha'>  
    ...
    <!-- START BLOCK : bloque_formulario -->     
    	<!-- INCLUDE BLOCK : www/templates/web/postulacion/201511_postdoctorado_formulario.tpls -->     
    <!-- END BLOCK : bloque_formulario --> 
    <!-- START BLOCK : bloque_formulario_carta -->     
    	<!-- INCLUDE BLOCK : www/templates/web/postulacion/201511_postdoctorado_formulario_carta.tpls -->     
