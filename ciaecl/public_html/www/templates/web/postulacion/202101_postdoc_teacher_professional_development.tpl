<a name="formulario"></a>
 <div class="contenido_titulo_separador">
  POSTDOCTORAL POSITION ON TEACHER PROFESSIONAL DEVELOPMENT</div>
...
<td style="width:65%; padding-right: 20px ">
 ...
 <!-- END BLOCK : bloque_formulario_cierre --> 
    	...
    	<input type="hidden" name="form_postulacion" value="202101_postdoc_teacher_professional_development">
<div id='inscripcion_ficha'>  
  ...
  <!-- INCLUDE BLOCK : www/templates/web/postulacion/202101_postdoc_teacher_professional_development_descripcion.tpl -->
 </div>
...
<!-- <li class="lateral_inscripcion" style="font-size:15px; " ><a href="javascript:mostrarDiv('inscripcion_programa');"><strong>Programa</strong>  </a></li> -->
 <li  class="lateral_inscripcion" style="font-size:13px; "  id="informacion_fecha" ><strong>Fecha cierre postulaci&oacute;n <!--/ Application Deadline--></strong><br /> 
  30 de marzo de 2021  </li>
 <li  class="lateral_inscripcion" style="font-size:13px; " >The application process will be opened until&nbsp;March 30, 2021.</li>     
