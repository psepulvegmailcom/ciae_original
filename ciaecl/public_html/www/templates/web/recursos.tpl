...
<!-- START BLOCK : bloque_recursos_view_recursos_ciae-->
<p></p>
</br>
 <h2 class="big-title">Recursos  </h2>
<!-- INCLUDE BLOCK : www/templates/web/lista_item_recurso.tpl --> 

<!-- END BLOCK : bloque_recursos_view_recursos_ciae --> 

<!-- START BLOCK : bloque_home_boletin_foco_detalle -->
		
<!-- INCLUDE BLOCK : www/templates/web/lista_item_recurso_foco.tpl --> 
<!-- END BLOCK : bloque_home_boletin_foco_detalle -->
		...
		<!-- START BLOCK : bloque_elemento --> 
            <div class="post-new row" style=" padding-top:2px; padding-bottom:2px; margin-left:30px; margin-right:10px;">
              ...
              <img src="imageview.php?image=recursos/{imagen}" class="img-responsive"  style="width:155px; height:100px"  alt='Imagen noticia {imagen}' />          
                ...
                <ul><li><a href="index.php?page={pagina_actual}&langSite={langSiteEspecial_seleccionado}&amp;id={id_recurso}">  {titulo}  </a><small style="color:#8E8E8E; text-transform:lowercase">[{tipo}]</small> </li></ul>            </div>      
