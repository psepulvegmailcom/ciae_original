...
// order
$objItemList->addOrder('name ASC,ps.statusKey ASC');
...
<!-- begin Time Clock edit --> 
				...
				<!--<th width="5%" class="act">Valor HH</th>
				<th width="5%" class="act">HH Est.</th>
				<th width="5%" class="act">Costo Estimado</th>-->
				<th width="8%" class="act"><?php echo $langForm['time']; ?></th>
				<!--<th width="5%" class="act">Costo Actual</th>
				<th width="5%" class="act">Costo Cobrado</th>-->
...
<!-- end Time Clock edit -->
		...
		?>
			<tr<?php echo $rowStyle; ?>>
				<td><a href="project_edit.php?id=<?php echo $objItem->id; ?>">
				
				<? $colorProject = $objItem->color; if(trim($colorProject) != '') { 
...
<!-- begin Time Clock addition -->			
				<!--<td align="center"><?php echo $objItem->pGetHHvalue(); ?></td>
				<td align="center"><?php echo $objItem->pGetEstimateTime($objItem->id); ?></td>
				<td align="center"><?php echo $objItem->pGetProjectValue('expected'); ?></td>-->
				<td align="center"><?php $objItem->pGetTime($objItem->id); ?></td>
				<!--<td align="center"><?php echo $objItem->pGetProjectValue('real'); ?></td>
				<td align="center"><?php if($objItem->projectvalue > 0) echo "$&nbsp;".number_format($objItem->projectvalue); else echo '-';?></td>-->
