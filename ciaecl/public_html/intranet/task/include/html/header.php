...
<head>
<title>Sistema de Tareas CIAE <?php if ($pPageTitle) { echo ' '.$pPageTitle; } ?></title>
...
<div id="header">
    <form name="zappa" action="index.php" method="POST" id="zappa">
      ...
      <div id="header1">
        ...
        <div><a href="<?php echo $_SESSION['linkItems']; ?>">
		<!--<img src="skins/<?php echo FRK_SKIN_FOLDER; ?>/images/logo.png" width="166" height="30" alt="TaskFreak!" border="0" />--></a></div>
      </div>
	  <div id="header2">
<?php
// -------------- NAV MENU ---------------------------------------------------
...
?>
        <div id="menu">
          <ul id="nav" class="level0">     
              ...
              <ul id="nav_projects" class="level1">
                ...
                <li class="more"><a href="<?php echo Tzn::concatUrl($pTmpLink,'show=today'); ?>" accesskey="l"><?php echo $langMenu['all_projects']; ?></a>
                  <ul>
					...
					<li><a href="<?php echo "index.php?sUser=".$_SESSION['tznUserId']."&sort=deadlineDate&dir=1&show=future"; ?>" accesskey="a">Mis Tareas </a></li>			
                  </ul>
                </li>
              <?php
			...
			<!-- <li>Sidwod
			   <ul class="level1">
                    <li><a href="sid_chilecompra.php">ChileCompra</a></li>
                  </ul>
			  </li> -->	
