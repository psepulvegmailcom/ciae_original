		...
		switch($pSort) {
			case 'priority':
				$this->addOrder('priority '.$this->getDir($pDir)
					.',expectedUrgency DESC, deadlineDate '.$this->getDir($pDir,'deadline'));
				break;
			case 'deadlineDate':
				$this->addOrder('expectedUrgency DESC,priority '.$this->getDir($pDir)
					.', deadlineDate '.$this->getDir($pDir,'deadline'));
				break;
			default:
				$this->addOrder($pSort.' '.$this->getDir($pDir)
					.', expectedUrgency DESC,priority '.$this->getDir($pDir)
					.', deadlineDate '.$this->getDir($pDir,'deadline'));
				break;
		}
	}
