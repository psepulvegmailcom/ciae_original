...
define('TZN_DB_USER','ciaebd_task');       // edit here
define('TZN_DB_PASS','ciaepassdev');           // edit here
define('TZN_DB_BASE','ciae_intranet-task');  // edit here
define('TZN_DB_PREFIX','v0');
...
define('PLG_EMAIL_FROM', "ciae@uchile.cl"); 
define('PLG_EMAIL_FROM_NAME', "Sistema de Tareas CIAE"); 
define('PLG_EMAIL_TO', "psepulveda@ciae.uchile.cl");
define('PLG_EMAIL_TO_COPY', true);
define('PLG_EMAIL_BCC', false);
define('PLG_EMAIL_ONLY_CREATE',true); //que solo envie cuando es creacion de una tarea
...
define('FRK_VERSION','0.6.1');
define('FRK_VERSION_RELEASE','2007-03-23');
...
define('FRK_DEFAULT_LANGUAGE','es');	// en, fr, it, de, nl, da, zh, pl
// TaskFreak! skin
define('FRK_DEFAULT_SKIN_FOLDER','redfreak'); // redfreak or bluefreak
// show own tasks or all users' tasks by default
define('FRK_DEFAULT_VIEW_OWN_TASKS',TRUE);
...
define('FRK_DEFAULT_COMMENT_ORDER','DESC');
