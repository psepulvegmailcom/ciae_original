  ...
  <div id="horiz" style="width:600px">
    ...
    <fieldset>
		...
		<table cellpadding="2" cellspacing="1" border="0" class="form">
			...
			<!--<tr>
				<th> Valor HH:</th>
				<td>$ <input value="<? if($objEditItem->HHvalue >0) echo $objEditItem->HHvalue;?>" name="HHvalue" class="dead"  />
				</td>
			</tr>
			<tr>
				<th> Costo Proyecto:</th>
				<td>$ <input value="<? if($objEditItem->projectvalue>0) echo $objEditItem->projectvalue;?>" name="projectvalue" class="dead"  />
				</td>
			</tr>-->
			
			<input name="HHvalue" value="0" type="hidden" />
			<input name="projectvalue" value="0" type="hidden" />
			<tr>
			...
			<tr>
				...
				<td><?php
				$color = random_color();
				 $objEditItem->qText('color',$color,'width:250px');  
				 ?> <font style=" background-color:#<?php echo $color;?>; height:20px; width:50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font> </td>
			</tr>
		</table>
        <?php
            if ($objEditItem->id) {
