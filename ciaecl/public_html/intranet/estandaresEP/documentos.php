...
<div id="contenido">
    <div id="ubica">
      <ul>
        ...
        <li class="ultimo"> Referencias Bibliográficas</li>
      </ul>
      </div><!-- fin ruta --> 
    <div class="clear"></div><img src="images/interior/ico_doc.gif" alt="foto" width="198" height="204" class="fotoDer1" />
        <h1>Recursos</h1>
          ...
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
          <h3><?php echo $_GET["descripcion"] ?> </h3>
   ...
   ?> 
			...
			<?php } ?> 
            <!--tr>
              <td class="linea2" ><span class="linea1"><span class="titulo"><a href="detalle_documentos.html">Título del Documento</a></span><a href="detalle_documentos.html"><br />
Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus.</a></span></td>
              ...
              <td nowrap="nowrap" class="fondopeso2"><a href="javascript:;"><img src="images/icono_ppt.gif" alt="power_point" width="34" height="18" border="0" /></a>25 kb </td>
            </tr>
            <tr>
              <td class="linea1"><span class="titulo"><a href="detalle_documentos.html">Título del Documento</a></span><a href="detalle_documentos.html"><br />
Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus.</a></td>
              ...
              <td nowrap="nowrap"><a href="javascript:;"><img src="images/icono_word.gif" alt="word" width="34" height="18" border="0" /></a>33 kb </td>
            </tr>
            <tr>
              <td class="linea2" ><span class="linea1"><span class="titulo"><a href="detalle_documentos.html">Título del Documento</a></span><a href="detalle_documentos.html"><br />
Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus.</a></span></td>
              <td nowrap="nowrap" class="fondopeso2">15/05/2008</td>
              <td nowrap="nowrap" class="fondopeso2"><a href="javascript:;"><img src="images/icono_zip.gif" alt="zip" width="34" height="18" border="0" /></a>418 kb </td>
            </tr>
            <tr>
              <td class="linea1"><span class="titulo"><a href="detalle_documentos.html">Título del Documento</a></span><a href="detalle_documentos.html"><br />
Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus.</a></td>
              <td nowrap="nowrap">15/05/2008</td>
              <td nowrap="nowrap"><a href="javascript:;"><img src="images/icono_pdf.gif" alt="pdf" width="34" height="18" border="0" /></a>450 kb </td>
            </tr>
            <tr>
              <td class="linea2" ><span class="linea1"><span class="titulo"><a href="detalle_documentos.html">Título del Documento</a></span><a href="detalle_documentos.html"><br />
Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus.</a></span></td>
