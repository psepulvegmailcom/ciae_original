...
<div id='bloque_titulo_persona_{id_titulo}'>
 <fieldset>
<div style=' text-transform:uppercase; font-size:120%; font-weight:bold; border-bottom:1px #333333 dotted; '> Diploma  <button type="button"  onclick="javascript:quitarTitulo('{id_titulo}')"><span>Eliminar Título</span></button></div>
 <div >
