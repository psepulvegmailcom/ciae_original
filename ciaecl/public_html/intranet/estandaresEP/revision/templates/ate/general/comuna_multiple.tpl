...
<div class="fieldset_title">Zona Cobertura <font id='ate_institucion_zona_cobertura_estado' class="edicion_enrevision"> {estado_edicion}</font></div>
<br />
...
<br />
		  ...
		  <img src="images/Info.ico" border='0'   />	Para seleccionar m&aacute;s de una comuna mantenga presionada la tecla CTRL + click en el elemento a seleccionar ó haga click en <em>Seleccionar Todo</em> para seleccionar todas las comunas de una regi&oacute;n
			<br />
		  <img src="images/Info.ico" border='0'   />	Para deseleccionar una comuna mantenga presionada la tecla CTRL + click en el elemento a deseleccionar ó haga click en <em>Deseleccionar Todo</em> para deseleccionar todas las comunas de una regi&oacute;n
			<br />
			<br /> 
