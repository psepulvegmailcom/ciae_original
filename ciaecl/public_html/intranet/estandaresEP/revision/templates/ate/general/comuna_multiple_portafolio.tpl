...
<script> var regiones = new Array();
var ir=0;</script>
		 	<br />  <img src="images/Info.ico" border='0'   />	Para seleccionar m&aacute;s de una comuna mantenga presionada la tecla CTRL + click en el elemento a seleccionar ó haga click en <em>Seleccionar Todo</em> para seleccionar todas las comunas de una regi&oacute;n
			<br />
...
<table  id="tabla_noborder">
	...
	<script>regiones[ir] = {region_id}; ir = ir+1;</script>
...
function saveComunasParent(){
	...
	if(comunas_sel == '')
	{
		showAlert('Debe seleccionar al menos una comuna');
		return false;
	}
	else
	{		 
