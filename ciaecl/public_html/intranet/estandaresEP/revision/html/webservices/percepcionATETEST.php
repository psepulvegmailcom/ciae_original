...
{ 
	...
	$output 			= $ControlPercepcion->consultarRegistroPercepcion(true);	  
	
	$ControlLogs = new ControlLogs();
	$ControlLogs->setLogSimple('webservicetest-percepcion',"rbd ($rbd-$rdbDv) rut ($rut) fecha ($fecha) codigo ($codigo) output ($output)");
