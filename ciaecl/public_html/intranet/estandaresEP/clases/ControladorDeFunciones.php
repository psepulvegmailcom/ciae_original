...
//		{		
//			sleep(1);
//			$email_webmaster 		= VarSystem::getInfoSystem('email_webmaster');
//			$email_webmaster_bcc 	= VarSystem::getInfoSystem('email_contacto');
...
//			$cabeceras .= 'From: '.$siteTitle['firm'].VarConfig::versionSitio.' <'.$email_webmaster_bcc.'>' . "\r\n";
//			$cabeceras .= 'Reply-To: '.$siteTitle['firm'].VarConfig::versionSitio.' <'.$email_webmaster_bcc.'>' . "\r\n";
//			$cabeceras .= "Message-ID: <".time()."-".$email_webmaster_bcc.">"."\r\n";
//			$cabeceras .= "X-Mailer: PHP v".phpversion()."\r\n";
//			$cabeceras .= 'Bcc: '.$email_webmaster;
//			if(trim($bcc_extra) != '')
//			{
//				$cabeceras .= ', '.$bcc_extra;
//			}
...
//			// $mensaje .= "<br /><br />Atentamente<br /><br />".$siteTitle['firm']."<br />";
//			//$mensaje .= ' <a href="'.VarConfig::path_site_www.'">'.VarConfig::path_site_www.'</a><br />'; 
//			
//			$mensaje = Funciones::TextoSimple($mensaje,true);
//			$mensaje = str_replace(">",">\n\r",$mensaje); 
//			
//			$f  = new miniTemplate(VarSystem::getPathVariables('dir_template_ate').'email/header_email.tpl');
//			$mensaje = $f->toHtml().$mensaje;			
//			$f  = new miniTemplate(VarSystem::getPathVariables('dir_template_ate').'email/footer_email.tpl');
//			$mensaje = $mensaje.$f->toHtml();			
//			
//	 		$asunto  = html_entity_decode($asunto); 
//	 		//echo $mensaje.'<br>';
//   
//			if(VarConfig::sendMail)
//			{
...
//			else
//			{
//				$aux_envio = array('ENVIO DE EMAIL',$para, $asunto, $mensaje, $cabeceras);
//				//Funciones::mostrarArreglo($aux_envio);
//			}
//    
//			if(!$es_masivo)
//			{
...
//				global $ControlHtml;
//				$ControlLogs->setLogEmail($cabeceras,$para,$ControlHtml->elUsuarioP->username,$mensaje,$asunto); 
//			}
//		}	
//		
//		function estadisticasSimples($casoGenerar,$sql)
//		{
//			$casoGenerar = $casoGenerar.'-'.date('YmdHis');
//			header('Content-type: application/vnd.ms-excel'); 
//			header("Content-Disposition: attachment; filename=".$casoGenerar.".xls");
...
//			$search = array(".","á","é","í","ó","ú",'ä','ë','ï','ö','ü',"ñ","'",'"',"Á","É","Í","Ó","Ú","Ñ"); 
// 			$replace = array("_","a","e","i","o","u","a","e","i","o","u","n","",'',"A","E","I","O","U","N");
...
//			{  
//		 		global $indexOutput;
//				$indexOutput .= "<div class='div_debug'>";  
//				$aux2 = split(' ',$sql); 
//	 			if(trim(strtoupper($aux2[0])) != 'SELECT')
//	 			{ 
//					$indexOutput .= '----INSERTADO----<BR><BR>';
//					$ControlLogs  = new ControlLogs();				
