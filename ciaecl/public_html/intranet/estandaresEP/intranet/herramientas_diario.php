 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div class="t-tabs">
    <ul class="tabs">
      ...
      <li><a href="diario.php">Presentación</a></li>      	  
...
<div id="contenido">
    <div id="ubica">
      <ul>
        <li class="primero"><a href="intranet.html" target="_top">Portada Intranet</a></li>
	...
	<?php     if(($perfil=="1")||($perfil=="2")){
		?>
	  <form name="fagregar" target="_self" action="nuevo_diario.php" method="post">
...
<a href="#" onclick="document.forms.fagregar.submit();return false"><img src="images/interior/nuevo_ico_diario1.gif" alt="nuevo" width="117" height="117" border="0" id="Image2" onmouseover="MM_swapImage('Image2','','images/interior/nuevo_ico_diario2.gif',1)" onmouseout="MM_swapImgRestore()" /></a>
	   	    <?php
	    }
	    ?>
        </form>
          ...
          <table align="center" cellspacing="0" class="dato">
            <tbody>
              <tr>
                ...
                <th nowrap="nowrap" scope="col">Mural</th>
   ...
   ?>
    ...
    while ($tema = mysql_fetch_array($sql)) { 
	  $texto = substr($tema["decripcion"], 0, 65);
	  $texto = $texto."...";
   ?> 
   				<tr>
                <td class="linea1"><?php echo Formatofecha($tema["fec_publicacion"]); ?></td>
                <td><span class="negrillas"><a href="#" onClick="location.replace('<?php echo "detalle_diario.php?id_tema=".$tema["id_tema"]; ?>')"><?php echo $tema["tema"];  ?></a> </span><br />
       			 <?php echo $texto; ?></td>
				<?php     if(($perfil=="1")||(($perfil=="2")&&($tema["id_autor"]==$usuario) ) ){
		   		?>
                <td nowrap="nowrap">
				<form name="feditar" target="_self" action="editar_diario.php" method="post">
				...
				<form name="fborrar" target="fprincipal" action="borrar_tema.php">
					<input name="Submit32" type="button" class="botones" value="Borrar" onClick="if (confirm('¿Estas seguro de borrar el diario?')){ document.location.href='<?php echo "eliminacion.php?id_tema=".$tema["id_tema"]."&flag=1"; ?>'}">
                  </form>
				 </td> 
			  <?php } 
