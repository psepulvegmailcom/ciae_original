...
<div id="contenido">
   ...
   ?> 
            <tr>
              <td class="linea1"><span class="titulo"><a href="#" onClick="location.replace('<?php echo "detalle_documentos.php?id_archivo=".$archivo["id_archivo"]."&id_tema=".$_GET["id_tema"]."&descripcion=".$_GET["descripcion"]."&descripcion2=".$_GET["descripcion2"]."&descripcion3=".$_GET["descripcion3"]."&tema=".$_GET["tema"] ?>')"><?php echo $archivo["titulo"]; ?></a></span><a href="detalle_documentos.html"><br />  
                 <?php echo $texto; ?></a></td>
