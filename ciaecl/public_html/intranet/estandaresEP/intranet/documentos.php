...
<div id="contenido">
   ...
   ?> 
            <tr>
              <td class="linea1"><span class="titulo"><a href="#" onClick="location.replace('<?php echo "detalle_documentos.php?id_archivo=".$archivo["id_archivo"]; ?>')"><?php echo $archivo["titulo"]; ?></a></span><a href="detalle_documentos.html"><br />  
                 <?php echo $texto; ?></a></td>
