 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div class="t-tabs">
    <ul class="tabs">
      ...
      <li><a href="diario.html">Presentación</a></li>      <li><a href="cuenta.html">Mi Cuenta</a></li>
     </ul>
  </div>
</div>
</div><!--   fin de div head-->
...
<div id="contenido">
    ...
    <div class="clear"></div><img src="images/interior/ico_herramientas.gif" alt="foto" width="117" height="117" class="fotoDer1" />
      ...
      <p>&nbsp;</p>
        ...
        <ol id="toc">
    <li ><a href="herramientas.php?id_tema=30&tema= Documentos&descripcion=&descripcion2=&descripcion3=&img1=&img2=&img3=&comentarios=1">Referencias Bibliográficas</a></li>
    <li ><a href="herramientas_articulos.php?id_tema=32&tema= Art&descripcion=Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus. Vivamus ut sem. Fusce aliquam nunc vitae purus. Aenean viverra malesuada libero. Fusce ac quam. Donec neque. Nunc venenatis enim nec quam. Cras faucibus, justo vel accumsan aliquam, tellus dui fringilla quam, in condimentum augue lorem non tellus. Pellentesque id arcu non sem placerat iaculis. Curabitur posuere, pede vitae lacinia accumsan, enim nibh elementum orci, ut volutpat eros sapien nec sapien. Suspendisse neque arcu, ultrices commodo, pellentesque sit amet, ul&descripcion2=comentario prueba 2&descripcion3=comentario prueba 3&img1=&img2=&img3=&comentarios=1">Artículos</a></li>
    <li class="current"><a href="herramientas_basesdedatos.php?id_tema=38&tema= Bases de datos&descripcion=La exigencia de creaci&descripcion2=&descripcion3=&img1=&img2=&img3=&comentarios=1">Bases de Datos</a></li>
    ...
    <li><a href="#">Presentación</a></li>
      ...
      <div class="conte"><a href="nuevo.html"><img src="images/interior/nuevo_ico_bdd1.gif" alt="nuevo" width="117" height="117" border="0" id="Image2" onmouseover="MM_swapImage('Image2','','images/interior/nuevo_ico_bdd2.gif',1)" onmouseout="MM_swapImgRestore()" /></a>
        </p>
          <p class="titulos">
          <table align="center" cellspacing="0" class="dato">
            <tbody>
              <tr>
                ...
                <th nowrap="nowrap" scope="col">Bases de datos</th>
