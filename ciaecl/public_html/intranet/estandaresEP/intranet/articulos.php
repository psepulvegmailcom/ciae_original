...
<div id="contenido">
    ...
    <div class="clear"></div><img src="images/interior/ico_articulos.gif" alt="foto" width="198" height="204" class="fotoDer1" />
      <h1>Recursos</h1>
          <h2>Artículos</h2>
          <h3>&nbsp;</h3>
          <h3>&nbsp;</h3>
   ...
   ?> 
            ...
            <!--tr>
              <td class="linea2" ><span class="linea1"><span class="titulo"><a href="detalle_articulos.html">Título del Artículo</a></span><a href="detalle_articulos.html"><br />
Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus.</a></span></td>
            ...
            <tr>
              <td class="linea1"><span class="titulo"><a href="detalle_articulos.html">Título del Artículo</a></span><a href="detalle_articulos.html"><br />
