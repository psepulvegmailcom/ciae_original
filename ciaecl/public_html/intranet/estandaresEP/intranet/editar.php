<?php
	...
	switch($id_tipo_tema)
	{
		case 2:
			...
			$titulos_archivo['form_titulo'] = 'Título';	 		
			$titulos_archivo['form_descripcion'] = 'Descripción';	
		break;
		case 3:
			...
			$titulos_archivo['form_titulo'] = 'Número de Estándar';		
			$titulos_archivo['form_descripcion'] = 'Descripción de Estándar';	
			$titulos_archivo['form_definicion'] = 'Definición de Estándar';	
			
			$datousua["form_titulo"] = str_replace('Documento','Estándar',$datousua["form_titulo"]);
		break;
	}
?>
	  ...
	  <form name="feditaarchivo" target="_self" action="editar.php" method="post" onSubmit="return fValidaEditArchivo(this, '¿Esta seguro de modificar la información del Archivo?');" enctype="multipart/form-data"> 
        <table align="center" cellspacing="0" class="dato" >   
          <tbody>
            ...
            <? if ($id_tipo_tema == 3) {?>
			 <tr>
              <td class="linea2" >Dominio <br><small>Seleccione el dominio correspondiente o ingréselo</small></td>
