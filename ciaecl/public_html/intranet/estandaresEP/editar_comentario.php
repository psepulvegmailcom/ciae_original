...
if($_POST["BTEditar"]=="Editar Comentario"){
   ...
   $resp = $funcionAgrega->EditaComentario($conn,$_POST["id_comentario"],$_POST["titulo"],$_POST["autor"],$_POST["correo"],$_POST["comentario"]);
   if($resp != "1"){
      $msg=$resp;
	}  
   else{
        ...
        <td ><table width="100%" height="20" border="0">
          <tr>
            <th width="29%" scope="col">&nbsp;</th>
              ...
              <th scope="col"><input name="BTcancelar222" type="button" class="botones" id="BTcancelar222" value="Volver" onclick="javascript:window.location='<?php echo $_SESSION["link_detalle"]; ?>'" ></th>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <th scope="col"><form name="fagregartema" target="fprincipal" action="editar_comentario.php" method="post" onSubmit="return fValidaInsertComentario(this, '¿Esta seguro de editar el comentario al archivo seleccionado?');"><table width="70%" border="0" align="center">
      <tr>
      ...
      <tr>
        <td ><table width="100%" height="20" border="0">
          <tr>
            <th width="29%" scope="col">&nbsp;</th>
<th width="23%" scope="col"><input name="id_comentario" id="id_comentario" type="hidden" value="<?php echo $_POST["id_comentario"]; ?>"><input name="id_archivo" id="id_archivo" type="hidden" value="<?php echo $_POST["id_archivo"]; ?>"><input name="BTEditar" type="submit" class="botones" id="BTEditar" value="Editar Comentario" ></th>
            <th width="1%" scope="col"><input name="BTcancelar2222" type="button" class="botones" id="BTcancelar2222" value="Volver" onclick="javascript:window.location='<?php echo $_SESSION["link_detalle"]; ?>'"></th>
            <th width="23%" scope="col"></th>
