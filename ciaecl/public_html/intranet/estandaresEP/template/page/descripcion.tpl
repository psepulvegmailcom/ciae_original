	...
	<img src="images/interior/fotos/actividades.gif" alt="foto" width="247" height="247" class="fotoDer1" />
          <h1>Descripción</h1>
          <h2>Información relevante del Núcleo</h2>
          ...
          <p class="titulos">Lorem ipsum dolor sit amet</p>
          
          <p><img src="images/interior/fotos/actividades2.jpg" alt="foto" width="140" height="140" class="fotoIzq" />Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis ligula lorem, consequat eget, tristique nec, auctor quis, purus. Vivamus ut sem. Fusce aliquam nunc vitae purus. Aenean viverra malesuada libero. Fusce ac quam. Donec neque. Nunc venenatis enim nec quam. Cras faucibus, justo vel accumsan aliquam, tellus dui fringilla quam, in condimentum augue lorem non tellus. Pellentesque id arcu non sem placerat iaculis. Curabitur posuere, pede vitae lacinia accumsan, enim nibh elementum orci, ut volutpat eros sapien nec sapien. Suspendisse neque arcu, ultrices commodo, pellentesque sit amet, ultricies ut, ipsum. Mauris et eros eget erat dapibus mollis. Mauris laoreet posuere odio. Nam ipsum ligula, ullamcorper eu, fringilla at, lacinia ut, augue. Nullam nunc.</p>
          <p>&nbsp;</p>
          <p class="titulos">Listado de Actividades</p>
