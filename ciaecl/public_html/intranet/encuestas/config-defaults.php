...
*
* $Id: config-defaults.php 7123 2009-06-16 15:33:54Z el-matador-69 $
*/
...
$databaseuser       =   'encuesta_ciae';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'encuesta_ciae_2009';            // Password of db user
...
$defaultlang        =   'es';             // The default language to use - the available languages are the directory names in the /locale dir - for example de = German
