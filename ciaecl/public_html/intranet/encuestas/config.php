...
$databasename       =   'ciaecl_encuestas';  // The name of the database that we will create
$databaseuser       =   'ciaecl_encuestas';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'encuestas_perjocar_75';            // Password of db user
$dbprefix           =   'lime_';       // A global prefix that can be added to all LimeSurvey tables. Use this if you are sharing
                                       // a database with other applications. Suggested prefix is 'lime_'

// File Locations
//$rooturl            =   "http://{$_SERVER['HTTP_HOST']}/encuestas_ciae"; //The root web url for your limesurvey installation (without a trailing slash). The double quotes (") are important.

$rooturl = "http://www.ciae.uchile.cl/intranet/encuestas";
...
// Site Setup
$sitename           =   'CIAE';     // The official name of the site (appears in the Window title)
...
$siteadminemail     =   'encuestasciae@ciae.uchile.cl'; // The default email address of the site administrator
$siteadminbounce    =   'webmaster@ciae.uchile.cl'; // The default email address used for error notification of sent messages for the site administrator (Return-Path)
$siteadminname      =   'Webmaster CIAE';      // The name of the site administrator
