...
<div id="contenido">
    <div id="ubica">
      <ul>
        ...
        <li class="normal"><a href="recursos.php?id_tema=<? echo $row["id_tema"]; ?>" target="_top"><? echo $row["tema"]; ?></a></li>
    ...
    <h1>Documento</h1>
          ...
          <br />
		  <span class="negrillas"><img src="images/bullet_lateral.gif" alt="flecha" width="7" height="7" /> Pa&iacute;s:</span><?php echo $row["pais"]  ?></p>		            <p><span class="negrillas"><img src="images/bullet_lateral.gif" alt="flecha" width="7" height="7" /> Publicado por:</span><?php echo $row["firstname"]." ".$row["lastname"];  ?>
					<br />
