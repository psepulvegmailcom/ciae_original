...
<div id="contenido">
    ...
    <li><a href="herramientas_articulos.php?id_tema=32">Artículos</a></li>
    <li><a href="herramientas_basesdedatos.php?id_tema=38">Bases de Datos</a></li>
    <li><a href="herramientas.php?id_tema=31">Hitos</a></li>
    <li><a href="herramientas_publicaciones.php?id_tema=29">Publicaciones</a></li>
    <li><a href="herramientas_diario.php">Diario Mural</a></li>
</ol>
      <div class="conte"></p>
        <table align="center" cellspacing="0" class="dato">
          <tbody>
			<tr>
              <th scope="col"><span class="mensaje"><? echo $msg; ?></span></th>
            </tr>

            <tr>
              <th scope="col"><a href="cuenta.php"><img src="images/generales/bot_volver.gif" alt="Cancelar" width="59" height="17" border="0" /></a></th>
            </tr>
          </tbody>
        </table>
        <p>&nbsp;</p>
