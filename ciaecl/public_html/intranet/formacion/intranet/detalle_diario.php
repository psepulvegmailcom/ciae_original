...
//-------Listar por un tema especifico-------//
 ...
 $autor_tema= $funcionBusqueda->BuscaAutortema($conn, $tema);
  ...
  if (isset($_SESSION['id_usuario'])) {
	  ...
	  $sql = $funcionBusqueda->ListarTemas($conn, $tema, $perfil, $usuario, $tipo);	  
      $sql_com = $funcionBusqueda->ComentariosTema($conn, $tema, $perfil, $usuario);
	  	    	 
  }else{ //usuario publico
     $sql = $funcionBusqueda->ListarTemas($conn, $tema, "0", $usuario, $tipo);
...
<body onload="MM_preloadImages('images/botonera/home2.gif','images/bajada/volver2.gif','images/bajada/imprimir2.gif','images/bajada/subir2.gif','images/interior/icochico_doc2.gif','images/interior/icochico_articulos2.gif','images/interior/icochico_bdd2.gif','images/interior/icochico_otros2.gif')">
<div id="todo">
<div id="head">
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <div class="t-tabs">
    <ul class="tabs">
      ...
      <li><a href="diario.php">Diario Mural</a></li>      <li><a href="cuenta.php"><strong>
...
<div id="contenido">
    ...
    <div class="clear"></div><img src="../images/interior/ico_noticias.gif" alt="foto" width="117" height="117" class="fotoDer1" />
          <h1>Diario Mural</h1>
         
          <p>&nbsp;</p>
      <p class="titulos"><? echo $tem["tema"]; ?> </p>
          <p class="fecha"><? echo $tem["fec_creacion"]; ?></p>
		  <div id="lineahor"><img src="../images/1x1.gif" alt="nada" /></div>
          <? if ($tem["img1"] !="") {?><p><img src="<?php echo "../".$rutaImg."/dir".$tema."/".$tem["img1"] ?>" alt="foto" width="200" height="150" border="0" class="fotoDer" ><? } echo $tem["descripcion"]; ?></p>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
          <p class="negrillas">&nbsp;</p>
        
        <? if ($tem["img2"] !="") {?><p><img src="<?php echo "../".$rutaImg."/dir".$tema."/".$tem["img2"] ?>" alt="foto" width="200" height="150" border="0" class="fotoIzq" ><? } echo $tem["descripcion2"]; ?></p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
	
       <? if ($tem["img3"] !="") {?><p><img src="<?php echo "../".$rutaImg."/dir".$tema."/".$tem["img3"] ?>" alt="foto" width="200" height="150" border="0" class="fotoIzq" ><? } echo $tem["descripcion3"]; ?></p>
				<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
        ...
        <div class="mapaAzul">
              <h5>&nbsp;</h5>
          &nbsp;&nbsp;&nbsp;&nbsp;Autor: <? echo $tem["firstname"]." ".$tem["lastname"];?> <br />
          &nbsp;&nbsp;&nbsp;&nbsp;Fecha: <? echo $tem["fec_creacion"]; ?> </div></div>
