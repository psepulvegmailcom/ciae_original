<?php
	...
	$valoresIdioma['bloques_areas']		 				= 'Áreas de investigación';
	$valoresIdioma['bloques_ver_mas'] 					= 'Ver más';
	$valoresIdioma['bloques_cierre'] 					= 'Ocultar Listado';
	
	$valoresIdioma['links_info_publicacion'] 			= 'Ver publicación';
	$valoresIdioma['menu_boletin'] 						= 'Boletín';
	$valoresIdioma['general_mantencion'] 				= 'Disculpe las molestias, pero el sistema se encuentra en mantención, por favor inténtelo más tarde';
	...
	$valoresIdioma['general_404_no_found'] 				= '<b>Página no encontrada</b><br><br>La página que usted busca no existe, ya no está disponible o cambió de dirección.<br><br>Ir al home <a href='.VarConfig::path_site_www.'>'.VarConfig::path_site_www.'</a>';
	 
	
	$valoresIdioma['publicaciones_filtro_todo'] 		= 'Todo';
	$valoresIdioma['publicaciones_ver_detalle'] 		= 'Ver detalle publicación';
	...
	$valoresIdioma['home_uchile_link'] 				= 'Institución albergante'; 
	$valoresIdioma['home_icm_link'] 				= 'Una iniciativa milenio';  
	$valoresIdioma['home_design_by'] 				= 'Desarrollado & Diseñado por';
	$valoresIdioma['home_rights'] 					= 'Derechos Reservados';

	$valoresIdioma['general_volver'] 				= 'Volver';
	$valoresIdioma['general_nombre'] 				= 'Nombre';
	$valoresIdioma['general_direccion'] 			= 'Dirección';
	$valoresIdioma['general_ciudad'] 				= 'Ciudad';
	$valoresIdioma['general_pais'] 					=' País';
	$valoresIdioma['general_profesion'] 			= 'Profesión';
	$valoresIdioma['general_actividad'] 			= 'Actividad';
	$valoresIdioma['general_telefono'] 				= 'Teléfono';
	...
	$valoresIdioma['contacto_mensaje_enviado'] 		= 'Su mensaje fue ingresado exitósamente';
	
	$valoresIdioma['formulario_alerta_base'] 		= 'Debe ingresar ';

	$valoresIdioma['agenda_fecha_inicio']			= 'Fecha Inicio'; 	
	$valoresIdioma['agenda_fecha_termino']			= 'Fecha Término'; 	
	...
	$valoresIdioma['agenda_dias_lista']				= Array ( 'lu' => 'Lunes','ma'=>'Martes','mi'=>'Miércoles','Ju'=>'Jueves','vi'=>'Viernes','sa'=>'Sábado','do'=>'Domingo');
	...
	$valoresIdioma['proyectos_area']				= "Área de Investigación";
	...
	$valoresIdioma['publicaciones_filtro_agno'] 	= 'Filtrar por años';
	$valoresIdioma['publicaciones_buscador_apellidos'] 	= 'Apellidos Autores';
	$valoresIdioma['publicaciones_tipo'] 			= 'Tipo de publicación';
