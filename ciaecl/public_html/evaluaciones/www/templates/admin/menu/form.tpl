 <script src='libjs/whizzywig.js' type='text/javascript'></script> 
...
<label>Menu Padre</label><br />
 <SELECT id="menu_padre" NAME="menu_padre" SIZE=""  class='inputtext'    ><OPTION VALUE="0">Menú Raíz </OPTION>	
...
<label>Tipo Menu</label><br />
 <SELECT id="tipo_archivo" NAME="tipo_archivo" SIZE=""  class='inputtext'    ><OPTION VALUE="0"><-- Seleccione Tipo Menú --> </OPTION>	
...
<!-- <br /> <strong>Nombre Menu</strong><br />
 ...
 <br /> <strong>Título Menu</strong><br />
