...
<br />
		  ...
		  <img src="cea/images/Info.ico" border='0'   />	Para seleccionar m&aacute;s de una comuna mantenga presionada la tecla CTRL + click en el elemento a seleccionar ó haga click en <em>Seleccionar Todo</em> para seleccionar todas las comunas de una regi&oacute;n
			<br />
