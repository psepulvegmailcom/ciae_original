                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                  ...
                  <!-- START BLOCK : bloque_banner_home -->                                 
                     <div class="item {active}">                      
               		 <img src="docs/image/banner/{imagen}" alt="Banner {titulo}" title="{titulo}" />
        ...
        <div class="col-sm-4 sidebar">
          <div class="orange caluga-sidebar">
            ...
            <div class="embed-responsive embed-responsive-16by9">
              ...
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MLLjFWrORz4" frameborder="0" allowfullscreen></iframe>
            </div>
          </div>
