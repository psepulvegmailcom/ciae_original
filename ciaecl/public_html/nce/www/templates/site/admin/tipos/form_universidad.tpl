...
<fieldset id='formulario_admin'> 
	...
	<div>
		...
		<input type="text"  class="inputtext"   name="form_universidad"  id="form_universidad"  value="{universidad}" maxlength="150" >
...
{   
	if(isEmpty(document.getElementById('form_universidad').value))
	{
		alert('Ingresar universidad');
		document.main.form_universidad.focus();
		return false;
	}    
