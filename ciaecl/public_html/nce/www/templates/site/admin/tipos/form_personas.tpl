...
<fieldset id='formulario_admin'> 
	...
	<div>
		...
		<input type="text"   class="inputtext"    name="form_descripcion"  id="form_descripcion"  value="{descripcion}" maxlength="150" >
	...
	<div>
		...
		<select  class="inputtext"   name='form_grupo'> 
		 <option value="direccion"  >Direcci&Oacute;n</option>  
		 <option value="gestion"  >Gesti&Oacute;n</option> 
