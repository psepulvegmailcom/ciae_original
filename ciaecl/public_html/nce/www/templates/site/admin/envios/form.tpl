...
<div class="fieldset_title">Proposal</div>
 ...
 <table width="100%" border="0" cellpadding="5"  cellspacing="3"   > 
  ...
  <tr>
    <td  style=" width:20%"><strong>Proposal File </strong></td>
    <td  style="width:70%"> 
       <a href="download.php?file=envios/{id_envio}/{archivo}">Download File</a>    </td>
  </tr> 
