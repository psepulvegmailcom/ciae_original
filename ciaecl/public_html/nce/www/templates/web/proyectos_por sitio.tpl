...
<div class="row">
        ...
        <div class="col-sm-8 single-new">
          <div class="grey-box-home">
            <h2 class="big-title" id='titulo_opcion'>Proyectos</h2>

            <div class="post-new row item-row">
                           <div class="col-md-12">
            
                <!-- START BLOCK : bloque_proyectos_por_defecto -->
                <p>{descripcion}</p>
              
				<!-- INCLUDE BLOCK : www/templates/web/proyectos_portada.tpl -->

                <!-- END BLOCK : bloque_proyectos_por_defecto -->
                
                <!-- START BLOCK : bloque_proyectos -->
                <p>{descripcion}</p>
              
				<!-- INCLUDE BLOCK : www/templates/web/proyectos_portada_me.tpl -->

                <!-- END BLOCK : bloque_proyectos -->
