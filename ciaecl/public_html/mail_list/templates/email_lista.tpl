...
<body  > 
<a href='email_lista.php?u=e889760b9a85dc871b2052565fd1147c'>Refrescar</a> <br><br>
<form name="main" method="post" action="email_lista.php?u=e889760b9a85dc871b2052565fd1147c">
<table style="width:80%"  border="0">
<tr><td colspan="2" style=" text-align:center"><strong style="font-size:120%">Lista de envio de email masivo CIAE</strong></td></tr>
<!-- START BLOCK : bloque_tipo_base_salida -->

<tr><td colspan="2" style="height:6px">
<span  style="font-size:90%">{total_email}</span><br>
<textarea style="  height:250px; width:900px; ">
<!-- START BLOCK : bloque_tipo_base_salida_email -->
{email}
<!-- END BLOCK : bloque_tipo_base_salida_email -->
</textarea>
</td></tr>
<!-- END BLOCK : bloque_tipo_base_salida -->
