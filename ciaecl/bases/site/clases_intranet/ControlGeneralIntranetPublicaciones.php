<?php
	...
	class ControlGeneralMantenedorPublicaciones extends ControlGeneral
	{
		function ControlGeneralMantenedorPublicaciones($path_admin,$ControlHtml)
		{
            ...
            $this->ControlClase  = new ControlPublicacionSitioObjeto();  
            //$this->ControlClase  = new ControlNoticiaObjeto();              
			$this->ControlClase->order = 'id_publicaciones DESC,'.$this->ControlClase->order ;   
			$this->ControlClase->group = ' id_publicaciones ';  
			$this->ObjetoClase  = new Publicaciones();
			parent::setObjetos($this->ControlClase,$this->ObjetoClase);	
			$this->tipo_palabras_clave = 'publicaciones';            			
		} 
		 
   		function mostrarListado()
    	{   	                    
            $this->arregloCamposBusqueda =  array('titulo','agno','tipo_publicacion','fecha');            
            $this->arregloCamposOrdenar  = 	array(array('titulo','T&iacute;tulo'), 
                                    		array('tipo_publicacion','Tipo'),
                                    		array('agno','Fecha'));
            ...
            $this->palabra = $this->valores['buscar_filtro_busqueda'];
           	$this->valBusquedaPalabra = array("titulo","resumen");                  		   			
		...
		function mostrarFormulario()
		{
			...
			// Funciones::mostrarArreglo($recursos_sitios,true);
...
/*			$this->ObjetoClase->buscarObjeto($this->valores['id_item']);
	...
	*/			 
			...
			$PublicacionesSitio = new PublicacionSitio();
			$PublicacionesSitio->eliminarObjeto($this->valores['id_item']); 
		}
