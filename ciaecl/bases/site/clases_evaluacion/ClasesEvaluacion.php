<?php
	 ...
	 *  
	 * @package CIAE Evaluaci&oacute;n
	 * @author Paulina Sep&uacute;lveda - psepulve@gmail.com  
	 * @copyright 2013
	 * @version 1.0
	 * @access public 
	...
	class ControlEvaluacionEnvioAsignacionRevision extends ControlObjetos
	{
	   ...
	   */
		...
		{ 
			$EvaluacionEnvioActividad = new EvaluacionEnvioActividad();
			$sql = "SELECT DISTINCT 
			a.id_evaluacion 	,a.id_etapa 	,a.username_revisor 	,a.username_revisado 	,a.id_envio, b.archivo, ".parent::getSqlDateTime('b.fecha','fecha_envio_html')."
