<?php
	...
	/** CLASE PARA CREAR ARCHIVOS DOCX */
	require_once $path_local.'PHPWord_0.6.2_Beta/PHPWord.php';
	
	/** CLASE PARA CREAR ARCHIVOS ENVIO DE CORREOS VIA SMTP */
	require_once $path_local.'/PHPMailer-master/class.phpmailer.php';
	
	/** CLASE PARA CREAR/LEER ARCHIVOS EXCEL */
	require_once $path_local.'PHPExcel-1.8/Classes/PHPExcel.php';
	...
	require_once $path_local.'fpdf181/fpdf.php';
	require_once $path_local.'fpdf181/fpdf_html.php';
