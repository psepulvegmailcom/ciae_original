...
class PHPWord_Template {
     ...
     */
    public function __construct($strFilename,$path='') {
        if(trim($path) == '')
		{
		...
		//echo "copy  ".$strFilename.'<br> '.$path.'<br>'.$this->_tempFileName;
        ...
        //echo htmlentities($this->_documentXML); 
	...
	{
        //$search = '${' . $search . '}';
        $search = 'VR_' . $search . '_VR';
        //echo 'function setValue '.$search.' '.$replace.'<br>';
	...
	{ 
        ...
        if ($this->_objZip->close() === false) 
        {
			...
			echo '<b>ERROR:</b> NO SE PUEDE ESCRIBIR INFORME'; 
		}
		else
		{
