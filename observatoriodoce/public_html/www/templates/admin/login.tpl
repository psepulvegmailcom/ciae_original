...
<td  style="border:none "   colspan="2">&nbsp;<font color="red" ><strong>{error}</strong></font></td> 
<td  style="border:none "  >&nbsp;</td>
</tr>
<tr>
<td  style="border:none "  >&nbsp;</td>
<td  style="border:none "  >Usuario:</td>
<td  style="border:none "  ><input type="text"  name="login_nombre" /></td>
<td  style="border:none "  >&nbsp;</td>
</tr>
...
<tr>
<td  style="border:none "  >&nbsp;</td>
<td  style="border:none "  >Clave:</td>
<td  style="border:none "  ><input type="password" name="login_clave" /></td>
<td  style="border:none "  >&nbsp;</td>
</tr>
<tr>
