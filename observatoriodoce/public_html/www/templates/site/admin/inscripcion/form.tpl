...
<table width="95%" border="0" cellpadding="3" style="font-size:">  
  ...
  <tr>
    <td   ><strong>Fecha Inscripci&oacute;n</strong></td>
    <td  > 
        {fecha_html}    </td>
  </tr> 
  
 <tr>
    <td   ><strong>Clave Inscripci&oacute;n</strong></td>
    <td  > {clave}    </td>
  </tr> 
 ...
 <tr>
    <td   style="vertical-align:top"><strong>&aacute;rea</strong></td>
    <td  style="vertical-align:top">  
	<ul>
 ...
 <tr>
    <td   ><strong>Comentario Inscripci&oacute;n</strong></td>
    <td  > {comentario}    </td>
  </tr> 
