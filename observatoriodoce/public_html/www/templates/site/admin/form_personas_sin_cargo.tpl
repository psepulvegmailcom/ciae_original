	...
	<script>
	function eliminarPersona(opcion, id_publicacion,id_persona,orden,nombre)
	{
		...
		enviar_accion_admin(opcion+'|modificar|eliminar_persona',id_publicacion);
	}
	</script>
	...
	<div>
		...
		<div>
		 ...
		 <td class="border_td">{orden_publicaciones}</td> 
		 <td class="border_td"><a href="javascript:eliminarPersona('{opcion_modulo}',{id_publicaciones},'{id_persona}',{orden_publicaciones},'{nombre_publicacion}');">
