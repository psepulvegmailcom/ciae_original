 ...
 <div class="row">
        ...
        <div class="col-sm-8 single-new">
          ...
          <div class="grey-box-home">
            <h2 class="title-grey-box">{langSite_menu_informes_ofd}</h2>
            <div class="grey-box-list">
        
             <ul>
            
<!-- START BLOCK : bloque_elemento_boletin -->
<li><a href="index.php?page=view_noticias&id={id_noticia}"  id="link_blank" > {titulo}    </a> <small>({mes_html} {agno})</small>&nbsp;&nbsp;&nbsp;    </li>
