<table width="90%" border="0" cellpadding="3">
  ...
  <tr>
    ...
    <td style="width:70%"> 
   <button  type="button" name="submit_enviar" value="submit_enviar" tabindex="28" onclick="javascript:enviarFormulario();" id="submit-submit_enviar">Generar Certificado</button>
  </td></tr>
