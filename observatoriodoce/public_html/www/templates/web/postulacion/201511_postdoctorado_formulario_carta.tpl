...
<table width="90%" border="0" cellpadding="3">
 ...
 <tr>
  ...
  <tr><td><strong>El postulante ya cumpli&oacute; con el n&Uacute;mero requerido de cartas de recomendacion. / The applicant has already completed the required number of recommendation letters.</strong> </td></tr>
  <!-- END BLOCK : bloque_formulario_carta_completo -->
  
  <!-- START BLOCK : bloque_formulario_carta_exito -->
  <tr><td><strong>La carta ha sido ingresada exitosamente. / The letter has been submitted successfully.</strong> </td></tr>
...
<tr>
    <td><strong id='campo_nombre'>Carta  de recomendacion / Recommendation Letter (*) (PDF) (Max 1.5 Mb) </strong></td>
     </tr>
    <tr><td>
