...
<!-- START BLOCK : bloque_recursos_view_recursos_general --->
<p></p>
 <h2 class="big-title">Publicaciones de inter&eacute;s general</h2>
<!-- INCLUDE BLOCK : www/templates/web/lista_item_recurso_pub.tpl -->
<!-- END BLOCK : bloque_recursos_view_recursos_general --->


<!-- START BLOCK : bloque_recursos_view_sistema_escolar -->
<p></p>
</br>
 <h2 class="big-title">Recursos para el sistema escolar </h2>
<!-- INCLUDE BLOCK : www/templates/web/lista_item_recurso.tpl -->
<!-- END BLOCK : bloque_recursos_view_sistema_escolar -->
...
<!-- END BLOCK : bloque_recursos_view_academicas -->
	...
	<!-- START BLOCK : bloque_elemento_enc -->
        <ul><h2 class="big-title">Recursos de interés {encabeza}</h2></ul>
  	<!-- END BLOCK : bloque_elemento_enc -->


		<!-- START BLOCK : bloque_elemento -->
            <div class="post-new row" style=" padding-top:2px; padding-bottom:2px; margin-left:30px; margin-right:10px; padding-bottom: 20px; padding-top: 10px;">
              <!--<div class="col-md-2">
              <img src="imageview.php?image=recursos/{imagen}" class="img-responsive"  style="width:100px; "  alt='Imagen noticia {imagen}' />
              </div>-->
               <div class="col-md-12">
				   <a href="index.php?page={pagina_actual}&langSite={langSiteEspecial_seleccionado}&amp;id={id_recurso}">  {titulo}  </a><br><small>{bajada}</small></<br><br><!--small>{autor}</small></<br><small style="color:#8E8E8E; text-transform:lowercase">[{tipo}]</small-->
              </div>
        </div>
        <p></p>
