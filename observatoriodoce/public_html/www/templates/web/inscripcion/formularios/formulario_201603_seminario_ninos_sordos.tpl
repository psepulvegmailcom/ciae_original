...
<td colspan="2"><br />
 ...
 <input type="hidden" name="form_tipo_inscripcion" value="201603_seminario_ninos_sordos">
 
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_lenguaje"> 
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_fonoaudiologia"> 
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_educacion_diferencial"> 
