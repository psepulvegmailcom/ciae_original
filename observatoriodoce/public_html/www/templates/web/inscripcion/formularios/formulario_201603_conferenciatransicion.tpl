...
<td colspan="2"><br />
 ...
 <input type="hidden" name="form_tipo_inscripcion" value="201603_conferenciatransicion_primera_infancia">
 
 <input type="hidden" name="bd_lista_extra[]" value="ciae_interesados_area_primera_infancia"> 
