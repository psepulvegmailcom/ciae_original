...
<br />--> Por favor, revise bien el ingreso de sus datos, tal cual como usted los ingrese ser&aacute;n utilizados en su certificaci&oacute;n. Sin posibilidad de modificaci&oacute;n. </strong></td></tr>
  <tr><td colspan="2">&nbsp;<br /></td></tr>
   ...
   <tr>
	...
	<input type="radio" name="form_tipo_inscripcion"  disabled="disabled"  value="20130727_mineduc_lenguaje_presencial"  > <!--27 de julio de 2013:  Asistencia presencial   <br> -->
    </div>
    
	<input type="radio" name="form_tipo_inscripcion"   value="20130727_mineduc_lenguaje_online" checked="checked"> <!--27 de julio de 2013:  Asistencia online v&Iacute;a streaming --> Participaci&oacute;n en sistema de actividades<br>
	<!--<br /><small>Por cupos la inscripci&oacute;n presencial se encuentra cerrada, solo quedan cupos en las inscripci&oacute;n online </small> -->
