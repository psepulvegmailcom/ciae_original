<a name="formulario"></a>
 ...
 <input type="hidden" name="form_tipo_inscripcion" value="201212-ValidacionPruebaEstudiantes">
...
<div id='inscripcion_ficha'> 
 ...
 <!-- INCLUDE BLOCK : www/templates/web/inscripcion/formularios/formulario_inicia_estudiante.tpl -->  
