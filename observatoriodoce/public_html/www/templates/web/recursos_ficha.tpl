<div class="container"> 
      <div class="row"> 
        ...
        <!-- START BLOCK : bloque_elemento_imgs -->
        <img src="imagenewview.php?image=recursos/{imagen}" width="640px" height="430px">
        <p></p>
        <!-- END BLOCK : bloque_elemento_imgs -->
       <!-- START BLOCK : bloque_elemento_video -->
        <iframe class="youtube-player" type="text/html" width="100%" height="385"  src="https://www.youtube.com/embed/{video}" frameborder="0"></iframe>
        <p></p>
...
<!-- END BLOCK : bloque_elemento_archivo -->
          ...
          <div class="blue box-style">
            ...
            <li><a href="{link_externo}" target="_blank">{link_externo_texto}</a>&nbsp;<a href="{link_externo}" target="_blank"   id="link_blank" ></a></li>          
