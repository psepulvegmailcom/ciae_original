	...
	<div class="navbar navbar-ciae" role="navigation">
		...
		<div class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<a href="https://www.facebook.com/ciae.uchile" target="_blank" class="social"><i class="fa fa-facebook"></i></a>
				</li>
				<li>
					<a href="http://twitter.com/ciae_uchile" class="social"><i class="fa fa-twitter"></i></a>
				</li>
				<li>
					<a href="https://www.youtube.com/c/CIAEUchile" class="social" target="_blank"><i class="fa fa-youtube"></i></a>
				</li>
				<li>
					<a href="rss.php" class="social" target="_blank"><i class="fa fa-rss"></i></a>
				</li>
			</ul>
		</div><!--/.nav-collapse -->
	</div>
